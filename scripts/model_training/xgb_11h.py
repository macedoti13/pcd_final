...
MODEL_WITH_WEATHER_SAVING_PATH = os.path.join(os.path.dirname(__file__), "../../models/xgb_with_weather_11h.pkl")
MODEL_SAVING_PATH = os.path.join(os.path.dirname(__file__), "../../models/xgb_11h.pkl")
