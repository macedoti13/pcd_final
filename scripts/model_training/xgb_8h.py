...
MODEL_WITH_WEATHER_SAVING_PATH = os.path.join(os.path.dirname(__file__), "../../models/xgb_with_weather_8h.pkl")
MODEL_SAVING_PATH = os.path.join(os.path.dirname(__file__), "../../models/xgb_8h.pkl")
