...
MODEL_WITH_WEATHER_SAVING_PATH = os.path.join(os.path.dirname(__file__), "../../models/xgb_with_weather_15h.pkl")
MODEL_SAVING_PATH = os.path.join(os.path.dirname(__file__), "../../models/xgb_15h.pkl")
